...
class ProjectSettingsPage extends StatelessWidget {
  ProjectSettingsPage({Key? key, required this.projectData})
      : super(key: key);
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                managerDetails(context, provider),
                SizedBox(
                  height: DimensionConstants.d24.h,
                ),
              (projectData.hoursFrom == null || projectData.hoursTo == null)
                  ? Container() : regularHours(context),
                (projectData.hoursFrom == null || projectData.hoursTo == null)
                    ? Container() : SizedBox(
                  height: DimensionConstants.d32.h,
                ),
                (projectData.projectDataBreak?.isEmpty == true)
                    ? Container() : breakWidget(context),
                (projectData.projectDataBreak?.isEmpty == true)
                    ? Container() : SizedBox(
                  height: DimensionConstants.d25.h,
                ),
                (projectData.roundTimesheets == "")
                    ? Container() : roundTimeWidget(context),
                (projectData.roundTimesheets == "")
                    ? Container() : SizedBox(
                  height: DimensionConstants.d36.h,
                ),
               provider.state == ViewState.busy ? const Center(child: CircularProgressIndicator(color: ColorConstants.primaryColor)) : Padding(
                    ...
                    onBtnTap: (){
                      showDialog(
                          ...
                          builder: (BuildContext context) =>
                              DialogHelper.leaveProjectDialog(context, cancel: (){
                                Navigator.of(context).pop();
                              }, leave: (){
                                Navigator.of(context).pop();
                                provider.crewLeavingProject(_scaffoldkey.currentContext!, projectData.id.toString());
                              }));
                    }
                  ),
                ),
  ...
  Widget notificationSwitcher(BuildContext context,
      ProjectSettingsProvider provider) {
    return Container(
  ...
  Widget managerDetails(BuildContext context, ProjectSettingsProvider provider) {
    return Container(
  ...
  Widget managerDetailsWidget(BuildContext context, ProjectSettingsProvider provider) {
    return Container(
      decoration: BoxDecoration(
        color: Theme
            .of(context)
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(projectData.manager!.name ?? "").boldText(
                        context, DimensionConstants.d16.sp, TextAlign.left),
                    Text("crew_manager_small".tr()).regularText(
                        context, DimensionConstants.d14.sp, TextAlign.left,
                        color: Theme
                            .of(context)
                            .brightness == Brightness.dark ? ColorConstants
                            .colorWhite : ColorConstants.colorBlack),
                  ],
                ),
                SizedBox(
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) =>
                            DialogHelper.callDialogBox(
                              context,
                              projectData.manager!.phoneNumber.toString(),
                                callManager: () {
                                  provider.makePhoneCall(projectData.manager!.phoneNumber.toString());
                                },
                                messageManager: () {
                                  provider.makeSms(projectData.manager!.phoneNumber.toString());
                                },
                                addToContactManager: () async {
                                  // Add a contact
                                  // The contact must have a firstName / lastName to be successfully added

                                  await ContactsService.addContact(Contact(displayName: projectData.manager!.name.toString(),
                                      phones: [Item(value: projectData.manager!.phoneNumber.toString())]));
                                }
                            ));
                  },
                  child: Container(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Container(
                ...
                child: Center(
                  child: Text(projectData.hoursFrom ?? "").regularText(
                    context,
                    DimensionConstants.d14.sp,
                    TextAlign.left,
                    color: Theme
              ...
              Container(
                ...
                child: Center(
                  child: Text(projectData.hoursTo ?? "").regularText(
                    context,
                    DimensionConstants.d14.sp,
                    TextAlign.left,
                    color: Theme
          ...
          Text("${"after_hour_rate".tr()}${projectData.afterHoursRate ?? ""}${"your_regular_rate".tr()}").regularText(
            context,
            DimensionConstants.d14.sp,
            TextAlign.left,
            color: Theme
  ...
  Widget breaksListView(){
    return ListView.builder(
      shrinkWrap: true,
      padding: EdgeInsets.zero,
      physics: const NeverScrollableScrollPhysics(),
      itemCount: projectData.projectDataBreak?.length,
        itemBuilder: (context, index){
      return Padding(
        padding: EdgeInsets.only(bottom: DimensionConstants.d8.h),
        child: Row(
          children: <Widget>[
            Container(
              height: DimensionConstants.d45.h,
              ...
              child: Center(
                child: Text(projectData.projectDataBreak?[index].startTime ?? "").regularText(
                  context,
                  DimensionConstants.d14.sp,
                  TextAlign.left,
                  color: Theme
            ...
            Container(
              ...
              child: Center(
                child: Text(projectData.projectDataBreak?[index].interval ?? "").regularText(
                  context,
                  DimensionConstants.d14.sp,
                  TextAlign.left,
                  color: Theme
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Text(projectData.roundTimesheets ?? "").regularText(
                context,
                DimensionConstants.d14.sp,
                TextAlign.left,
                color: Theme
