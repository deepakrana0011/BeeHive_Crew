      ...
      builder: (context, provider, _) {
        return Scaffold(
          appBar: CommonWidgets.appBarWithTitleAndAction(context,
              ...
              onTapAction: () {
                Navigator.pushNamed(
                    context, RouteConstants.notificationsScreen);
              },
              popFunction: () {
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          takePictureBox(context, ImageConstants.galleryIcon, "upload", () {
                    ...
                    /*Container(
                      ...
                      child: provider.profileImage != " "
                          ...
                          borderRadius: BorderRadius.circular(
                              DimensionConstants.d8.r),
                          child: ImageView(
                            path: provider.profileImage, fit: BoxFit.fill,))
                          : Container(),
                    ),*/
                    Stack(
                      children: [
                        Container(
                          ...
                          child: provider.certificateImage != " " ? ClipRRect(
                              borderRadius: BorderRadius.circular(DimensionConstants
                                  .d8.r),
                              child: ImageView(path: provider.certificateImage,
                        ...
                        Positioned(
                            ...
                            child: GestureDetector(
                                ...
                                child: provider.certificateImage != " " ? const ImageView(
                    ...
                    Padding(
                      ...
                      child: CommonWidgets.commonButton(context, "save".tr(),
                          ...
                          onBtnTap: () {
                            CommonWidgets.hideKeyboard(context);
                            if (certificationNameController.text
                                .trim()
                                .isEmpty) {
                              DialogHelper.showMessage(
                                  context, "certification_name_required".tr());
                            } else if (provider.certificateImage == " ") {
                              DialogHelper.showMessage(
                                  context, "add_certification_image".tr());
                            } else {
                              provider.addCertificate(
                                  context, provider.certificateImage,
                                  certificationNameController.text.trim())
                                  .then((value) {
                                if (value == true) {
