...
class EmailAddressScreenManager extends StatelessWidget {
  EmailAddressScreenManager({Key? key, this.fromForgotPassword})
      : super(key: key);
                              ...
                              CommonWidgets.commonButton(
                                ...
                                fromForgotPassword == true
                                    ? Navigator.pushNamed(
                                        ...
                                        arguments:
                                            const OtpVerificationPageManager())
                                    : Navigator.pushNamed(context,
                                        RouteConstants.signUpScreenManager,
                                        arguments: SignUpScreenManager(
  ...
  Widget emailTextField(BaseProvider provider) {
    return TextFormField(
      ...
      decoration: ViewDecoration.inputDecorationTextField(
          ...
          suffixIcon: fromForgotPassword == true
              ? null
              : IconButton(
