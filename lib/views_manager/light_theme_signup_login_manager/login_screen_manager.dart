...
class LoginScreenManager extends StatelessWidget {
  String? email;

  LoginScreenManager({Key? key, this.email}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BaseView<LoginManagerProvider>(onModelReady: (provider) {
