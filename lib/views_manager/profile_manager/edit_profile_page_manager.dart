...
class EditProfilePageManager extends StatefulWidget {
  ...
  @override
  State<EditProfilePageManager> createState() {
    return _EditProfilePageManagerState();
  }
}
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      textFiledName(context, "name",
                          provider.nameController),
                      SizedBox(
                        height: DimensionConstants.d16.h,
                      ),
                      textFiledName(context, "title",
                          provider.titleController),
                      SizedBox(
                        height: DimensionConstants.d16.h,
                      ),
                      textFiledName(context, "company",
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text("custom_colour".tr()).boldText(context,
                                DimensionConstants.d16.sp, TextAlign.left,
                                color: ColorConstants.colorBlack),
                            Expanded(child: Container()),
                            Text("default_blue".tr()).regularText(context,
                      ...
                      textFiledName(context, "phone",
                          provider.phoneController,
                          phoneNo: true),
                      SizedBox(
                        height: DimensionConstants.d16.h,
                      ),
                      textFiledName(context, "email",
...
Widget textFiledName(BuildContext context, String title,
