...
class CertificationPageManager extends StatelessWidget {
  const CertificationPageManager({Key? key}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      takePictureBox(
                        ...
                        provider.profileImage == " "?  provider.addProfilePic(context, 2):null;
                      }),
                      takePictureBox(
                          context, ImageConstants.cameraIcon, "take_picture", () {
                       provider.profileImage == " "? provider.addProfilePic(context, 1):null;
                      }),
                    ],
                  ),
                ),
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        child: GestureDetector(
                            ...
                            child:provider.profileImage != " "? ImageView(path: ImageConstants.crossIcon,):Container()))
                  ],
                ),
                SizedBox(
