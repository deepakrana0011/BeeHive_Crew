...
Widget checkByWeekSubstring(BuildContext context, ProjectsManagerProvider provider, int i){
...
Widget projectNameSubStringContainer(BuildContext context, ProjectsManagerProvider provider, int weekDaysIndex){
