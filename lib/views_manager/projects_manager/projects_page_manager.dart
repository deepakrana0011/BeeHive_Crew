...
class _ProjectsPageManagerState extends State<ProjectsPageManager>
  ...
  void _observer() {
    openScheduleScreen =
        Provider.of<BottomBarManagerProvider>(context, listen: true)
            .showScheduleScreen;
  }
                  ...
                  children: <Widget>[
                    Expanded(
                      child: provider.allProjectsManagerResponse!.projectData!
                              .isNotEmpty
                          ? tabBarView(_scaffoldkey.currentContext!,
                              tabController, provider, bottomBarProvider)
                          : Center(
      ...
      child: Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return Padding(
                padding:
                    EdgeInsets.symmetric(vertical: DimensionConstants.d5.h),
                child: GestureDetector(
                  onTap: () {
                    bottomBarProvider?.pageView(1);
                    bottomBarProvider?.updateNavigationValue(5,
                        projectId: provider.allProjectsManagerResponse
                            ...
                            child: Row(
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      Text(provider.getTotalHoursPerProject(
                                              provider
  ...
  Widget checkByWeekSubstring(
      BuildContext context, ProjectsManagerProvider provider, int i) {
            ...
            onTap: () async {
              await provider
                  .crewOnThisProject(
                      context,
                      provider
                          .projectNameList[weekDaysIndex].projectName[index].sId
                          .toString())
                  .then((value) {
                if (value == true) {
                  bottomSheetProjectDetails(_scaffoldkey.currentContext!,
                      onTap: () {},
