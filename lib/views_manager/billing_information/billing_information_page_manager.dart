...
class BillingInformationPageManager extends StatelessWidget {
  ...
  BillingInformationPageManager({Key? key, required this.texOrNot})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            CommonWidgets.Divider(DimensionConstants.d1.h,
                DimensionConstants.d375.w, ColorConstants.grayF3F3F3),
            SizedBox(
              height: DimensionConstants.d20.h,
            ),
...
Widget billingInformationWidget(BuildContext context, bool texPrNot) {
  return Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text("dear_customer".tr()).regularText(
            context, DimensionConstants.d14.sp, TextAlign.left,
            color: ColorConstants.colorBlack),
        SizedBox(
          height: DimensionConstants.d20.h,
        ),
        Text("you_have_the_following_purchase_with_details".tr()).regularText(
            context, DimensionConstants.d14.sp, TextAlign.left,
            color: ColorConstants.colorBlack),
        SizedBox(
        ...
        Text("para1".tr()).regularText(
            context, DimensionConstants.d14.sp, TextAlign.left,
            color: ColorConstants.colorBlack),
        SizedBox(
          height: DimensionConstants.d20.h,
        ),
        Text("para2".tr()).regularText(
            context, DimensionConstants.d14.sp, TextAlign.left,
            color: ColorConstants.colorBlack),
        SizedBox(
          height: DimensionConstants.d20.h,
        ),
        Text("para3".tr()).regularText(
            context, DimensionConstants.d14.sp, TextAlign.left,
            color: ColorConstants.colorBlack),
        SizedBox(
        ...
        Container(
          ...
          child: Center(
            child: Text("cancel_your_purchase".tr()).boldText(
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        rowForDetails(context, "subscription", "Additional Crew Member",
        ...
        SizedBox(
          height: texOrNot == true
              ? DimensionConstants.d19.h
              : DimensionConstants.d1.h,
        ),
        texOrNot == texOrNot
            ? rowForDetails(context, "tax", "\$2.00", DimensionConstants.d72.w)
            : Container(),
        SizedBox(
          height: DimensionConstants.d19.h,
        ),
        rowForDetails(
            context, "total_price", "\$25.00", DimensionConstants.d30.w),
      ],
    ),
  );
}

Widget rowForDetails(
    BuildContext context, String filedName, String detailName, double width) {
  return Row(
    children: <Widget>[
      Text(filedName.tr()).regularText(
          context, DimensionConstants.d14.sp, TextAlign.left,
          color: ColorConstants.colorBlack),
